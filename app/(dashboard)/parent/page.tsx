...
import { CreditCard, Receipt, FileText, ArrowRight, DollarSign } from "lucide-react";
...
export default function ParentDashboardPage() {
    ...
    const pendingFees = [
        { id: "FEE005", description: "Term 2 Tuition Fee", amount: 500, due: "Oct 30, 2026" },
        { id: "FEE006", description: "Transport Fee", amount: 150, due: "Oct 30, 2026" },
    ];

    const paidFees = [
        { id: "FEE001", description: "Term 1 Tuition Fee", amount: 500, paidOn: "Mar 10, 2026" },
        { id: "FEE002", description: "Admission Fee", amount: 200, paidOn: "Jan 15, 2026" },
    ];
        ...
        <div className="flex-1 space-y-6 p-4 md:p-8 pt-6">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <Card className="col-span-1 lg:col-span-2 border-primary/20 bg-primary/5">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2"><DollarSign className="h-5 w-5 text-primary" /> Fees Overview</CardTitle>
                        <CardDescription>Outstanding balance for all your dependents.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="flex items-center justify-between">
                            <div>
                                <div className="text-4xl font-bold tracking-tight text-slate-900">${totalDue}</div>
                        ...
                        <div className="space-y-4">
                            {paidFees.map((fee) => (
                                <div key={fee.id} className="flex justify-between items-center border-b pb-4 last:border-0 last:pb-0">
                                    ...
                                    <div className="text-right">
                                        <div className="font-semibold text-green-600">${fee.amount}</div>
